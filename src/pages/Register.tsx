  ...
  return (
    <div className="min-h-screen pt-24 px-6 flex items-center justify-center">
      <div className="w-full max-w-md p-8 rounded-2xl bg-[#16161f] border border-[#fbf0df]/5">
        <h1 className="text-3xl font-bold text-[#fbf0df] mb-8 text-center">Créer un compte</h1>
        ...
        <form onSubmit={async (e) => {
          ...
          <div>
            <label htmlFor="username" className="block text-sm font-bold text-[#fbf0df] mb-2">Nom d'utilisateur</label>
          ...
          <div>
            <label htmlFor="confirm" className="block text-sm font-bold text-[#fbf0df] mb-2">Confirmer le mot de passe</label>
